...
function DropdownSubmenu({
  ...
  return (
    ...
    <div className='relative bg-black flex flex-row items-center '>
      <button
      ...
      {openSubmenu && (
        <div className='absolute top-0 left-full bg-black p-6 min-w-max h-fit flex flex-col justify-start items-start ml-[25px] gap-4 text-sm z-10 rounded-md'>
            {children}
        </div>
      )}
    </div>
