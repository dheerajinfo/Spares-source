...
function SidebarDemo() {
  ...
  return (
    ...
    {!isCollapsed && (  
    <Sidebar className='bg-black absolute top-0 border-r border-white/10 max-h-96 noscrollbar'>
      ...
      <SidebarFooter>
        ...
        <SidebarfooterOptions className='bg-black rounded-8 py-3 ml-6'>
          <button className='w-full h-10 px-6 text-nowrap text-white bg-black flex items-center gap-3 text-sm font-medium tracking-wide hover:bg-white hover:bg-opacity-10 rounded-4'>
        ...
        <button className='w-full h-10 px-6 text-white bg-black flex items-center gap-3 text-sm font-medium tracking-wide hover:bg-white hover:bg-opacity-10 rounded-md'>
    ...
    {isCollapsed && (
    <CollapsedSidebar className='bg-black absolute top-0 left-0 border-r border-white/10 max-h-96 noscrollbar'>
        ...
        <CollapsedsidebarContent className='pt-6 pl-1'>
          <SidebarGroup className='flex flex-col gap-4'>
            <CollapsedsidebarIconbutton tooltipText='Dashboard'>
            ...
            <CollapsedsidebarIconbutton tooltipText='Courses'>
            ...
            <CollapsedsidebarIconbutton tooltipText='Tracks'>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 1V17M17 6V12M1 6V12M5 4V14M13 4V14" stroke="white" strokeLinecap="round"/>
              </svg>
            </CollapsedsidebarIconbutton>
            <CollapsedsidebarIconbutton tooltipText='Workshops'>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <CollapsedsidebarIconbutton tooltipText='Practice'>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <CollapsedsidebarIconbutton tooltipText='Projects'>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <CollapsedsidebarIconbutton tooltipText='Library'>
            ...
            <CollapsedsidebarIconbutton tooltipText='Questions'>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <CollapsedsidebarIconbutton tooltipText='Guides'>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <CollapsedsidebarFooter>
          <CollapsedsidebarfooterOptions className='ml-6 py-3 rounded-8 bg-black' optionsButton={<SidebarAvatar iconsize={'12'}/>}>
            <button className='w-full h-10 px-6 text-white bg-black flex items-center gap-3 text-sm font-medium tracking-wide hover:bg-white hover:bg-opacity-10 rounded-4'>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.67232 3.16654C6.10874 2.73013 6.72219 2.51965 7.33461 2.5962L10.4773 2.98904C11.3852 3.10252 12.1003 3.81764 12.2138 4.72552L12.6066 7.86822C12.6832 8.48064 12.4727 9.09409 12.0363 9.5305L7.77821 13.7886C6.99716 14.5696 5.73083 14.5696 4.94978 13.7886L1.41425 10.253C0.633197 9.472 0.633198 8.20567 1.41425 7.42462L5.67232 3.16654Z" stroke="white"/>
                <path d="M10.6995 5.14636C10.2843 4.77989 10.0225 4.24371 10.0225 3.64636C10.0225 2.54179 10.9179 1.64636 12.0225 1.64636C13.127 1.64636 14.0225 2.54179 14.0225 3.64636C14.0225 4.52097 13.4611 5.26445 12.679 5.53612" stroke="white" strokeLinecap="round"/>
              </svg>
